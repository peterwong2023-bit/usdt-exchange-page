...
positions = driver.execute_script("""
  ...
  res.content_left = mn.children[0].getBoundingClientRect().x;
  res.content_right = mn.children[0].getBoundingClientRect().right;
  ...
  var wlTitle = document.querySelector('.wl-title');
  ...
  if (cds[0]) { var cd0 = cds[0].getBoundingClientRect(); res.m6 = [cd0.x, cd0.y - 4, cd0.right, cd0.bottom + 4]; }
  if (cds[1]) { var cd1 = cds[1].getBoundingClientRect(); res.m7 = [cd1.x, cd1.y - 4, cd1.right, cd1.bottom + 4]; }
